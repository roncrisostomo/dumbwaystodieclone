...
public class SoundObject : MonoBehaviour
{
	...
	/// <summary>
	/// Pause the specified pauseAll.
	/// </summary>
	/// <param name="pauseAll">If set to <c>true</c> was paused from SoundSystem's PauseAllSounds.</param>
	...
	/// </summary>
	/// <param name="unpauseAll">If set to <c>true</c> was unpaused from SoundSystem's UnpauseAllSounds.</param>
	...
	/// </summary>
	/// <param name="muteAll">If set to <c>true</c> was muted from SoundSystem's MuteAllSounds.</param>
	...
	/// </summary>
	/// <param name="unmuteAll">If set to <c>true</c> was unmuted from SoundSystem's UnmuteAllSounds.</param>
	...
	/// </summary>
	/// <param name="calledBySoundSystem">If set to <c>true</c> delete was called by a sound system.</param>
	public void Delete(bool calledBySoundSystem = false)
	{
		// If deleted by anything other than sound system, inform sound system of this object's deletion
		if (!calledBySoundSystem)
		{
			m_soundSystem.NotifySoundObjectDeletion(this);
		}
		// Destroy this object
	...
	/// <summary>
	/// This initialization method should be called by SoundSystem classes only.
	/// </summary>
	/// <param name="soundSystem">Sound system handling this sound object.</param>
	...
	public bool Initialize(SoundSystemBase soundSystem, SoundInfo.SoundType soundType, bool startMuted)
	{
		if (soundSystem == null)
		{
			return false;
		...
		// If initialized by SoundSystem as muted, consider this muted via MuteAll
		if (startMuted)
		{
			Mute(true);
		}
